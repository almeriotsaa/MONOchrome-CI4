        ...
        <main class="flex-1 flex flex-col min-w-0">
            ...
            <div class="p-8 lg:p-12 space-y-12 max-w-7xl mx-auto w-full">
                ...
                <section class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="p-8 border border-black flex flex-col justify-between h-48">
                        <div class="flex justify-between items-start">
                            <span class="text-[11px] font-bold uppercase tracking-widest">Total Revenue</span>
                            <span class="material-symbols-outlined">trending_up</span>
                        </div>
                        <div>
                            <p class="text-3xl font-light tracking-tighter">$<?= number_format($totalRevenue ?? 124500, 2) ?></p>
                            <p class="text-[10px] font-bold mt-1 uppercase tracking-widest">+8.4% VS LAST MONTH</p>
                        </div>
                    </div>
